...
template <class T> inline vec2g<T> mix(const vec2g<T>& v1, const vec2g<T>& v2, double s) { return (T(1) - s) * v1 + s * v2; }
...
template <class T> inline vec4g<T> mix(const vec4g<T>& v1, const vec4g<T>& v2, double s) { return (T(1) - s) * v1 + s * v2; }
...
template <class T> inline std::ostream& operator<<(std::ostream& out, const vec2g<T>& v) {
	return out << v.x << "  " << v.y;
}

template <class T> inline std::istream& operator >> (std::istream& in, vec2g<T>& v) {
	return in >> v.x >> v.y;
}
...
template <class T> inline std::ostream& operator<<(std::ostream& out, const vec4g<T>& v) {
	return out << v.x << "  " << v.y << "  " << v.z << " " << v.w;
}

template <class T> inline std::istream& operator >> (std::istream& in, vec4g<T>& v) {
